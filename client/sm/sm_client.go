...
func (a *Client) GetNetworkSmTrustedAccessConfigs(params *GetNetworkSmTrustedAccessConfigsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetworkSmTrustedAccessConfigsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetworkSmTrustedAccessConfigsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getNetworkSmTrustedAccessConfigs",
		Method:             "GET",
		PathPattern:        "/networks/{networkId}/sm/trustedAccessConfigs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetworkSmTrustedAccessConfigsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetworkSmTrustedAccessConfigsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getNetworkSmTrustedAccessConfigs: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
