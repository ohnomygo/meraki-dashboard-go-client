...
func (o *GetNetworkSmDeviceSecurityCentersOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkSmDeviceSecurityCentersOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network sm device security centers o k response
func (o *GetNetworkSmDeviceSecurityCentersOK) Code() int {
	return 200
}
...
func (o *GetNetworkSmDeviceSecurityCentersOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/sm/devices/{deviceId}/securityCenters][%d] getNetworkSmDeviceSecurityCentersOK  %+v", 200, o.Payload)
}

func (o *GetNetworkSmDeviceSecurityCentersOK) GetPayload() []*GetNetworkSmDeviceSecurityCentersOKBodyItems0 {
	return o.Payload
}
...
/*
GetNetworkSmDeviceSecurityCentersOKBodyItems0 get network sm device security centers o k body items0
swagger:model GetNetworkSmDeviceSecurityCentersOKBodyItems0
*/
...
func (o *GetNetworkSmDeviceSecurityCentersOKBodyItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get network sm device security centers o k body items0 based on context it is used
func (o *GetNetworkSmDeviceSecurityCentersOKBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetNetworkSmDeviceSecurityCentersOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetNetworkSmDeviceSecurityCentersOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetNetworkSmDeviceSecurityCentersOKBodyItems0
