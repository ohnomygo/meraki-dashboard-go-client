...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) IsSuccess() bool {
	return true
}
...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) IsRedirect() bool {
	return false
}
...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) IsClientError() bool {
	return false
}
...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) IsServerError() bool {
	return false
}
...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) IsCode(code int) bool {
	return code == 201
}

// Code gets the status code for the create network sm bypass activation lock attempt created response
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) Code() int {
	return 201
}
...
func (o *CreateNetworkSmBypassActivationLockAttemptCreated) String() string {
	return fmt.Sprintf("[POST /networks/{networkId}/sm/bypassActivationLockAttempts][%d] createNetworkSmBypassActivationLockAttemptCreated  %+v", 201, o.Payload)
}
