...
func (o *GetNetworkSmBypassActivationLockAttemptOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network sm bypass activation lock attempt o k response
func (o *GetNetworkSmBypassActivationLockAttemptOK) Code() int {
	return 200
}
...
func (o *GetNetworkSmBypassActivationLockAttemptOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/sm/bypassActivationLockAttempts/{attemptId}][%d] getNetworkSmBypassActivationLockAttemptOK  %+v", 200, o.Payload)
}
