...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) IsSuccess() bool {
	return true
}
...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) IsClientError() bool {
	return false
}
...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) IsServerError() bool {
	return false
}
...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update network switch routing multicast rendezvous point o k response
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) Code() int {
	return 200
}
...
func (o *UpdateNetworkSwitchRoutingMulticastRendezvousPointOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/switch/routing/multicast/rendezvousPoints/{rendezvousPointId}][%d] updateNetworkSwitchRoutingMulticastRendezvousPointOK  %+v", 200, o.Payload)
}
