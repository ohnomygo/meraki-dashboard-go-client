...
func (o *UpdateNetworkSwitchRoutingMulticastOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network switch routing multicast o k response has a 3xx status code
func (o *UpdateNetworkSwitchRoutingMulticastOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkSwitchRoutingMulticastOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkSwitchRoutingMulticastOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/switch/routing/multicast][%d] updateNetworkSwitchRoutingMulticastOK  %+v", 200, o.Payload)
}
