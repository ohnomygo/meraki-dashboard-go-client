...
func (o *GetNetworkSwitchLinkAggregationsOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkSwitchLinkAggregationsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network switch link aggregations o k response
func (o *GetNetworkSwitchLinkAggregationsOK) Code() int {
	return 200
}
...
func (o *GetNetworkSwitchLinkAggregationsOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/linkAggregations][%d] getNetworkSwitchLinkAggregationsOK  %+v", 200, o.Payload)
}
