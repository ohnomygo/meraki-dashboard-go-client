...
// NewGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams creates a new GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams object,
...
func NewGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams() *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	return &GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParamsWithTimeout creates a new GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams object
...
// NewGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParamsWithContext creates a new GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams object
...
// NewGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParamsWithHTTPClient creates a new GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams object
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithDefaults() *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithTimeout(timeout time.Duration) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithContext(ctx context.Context) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithHTTPClient(client *http.Client) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithEndingBefore(endingBefore *string) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetEndingBefore(endingBefore *string) {
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithNetworkID(networkID string) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetNetworkID(networkID)
	return o
}

// SetNetworkID adds the networkId to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetNetworkID(networkID string) {
	o.NetworkID = networkID
}

// WithPerPage adds the perPage to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithPerPage(perPage *int64) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the get network switch dhcp server policy arp inspection trusted servers params
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetPerPage(perPage *int64) {
	o.PerPage = perPage
}
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WithStartingAfter(startingAfter *string) *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams {
...
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) SetStartingAfter(startingAfter *string) {
	o.StartingAfter = startingAfter
}

// WriteToRequest writes these params to a swagger request
func (o *GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
