...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) IsClientError() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) IsServerError() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network switch routing multicast rendezvous point o k response
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) Code() int {
	return 200
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/routing/multicast/rendezvousPoints/{rendezvousPointId}][%d] getNetworkSwitchRoutingMulticastRendezvousPointOK  %+v", 200, o.Payload)
}
