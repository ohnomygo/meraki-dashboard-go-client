...
func (o *DeleteNetworkSwitchLinkAggregationNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete network switch link aggregation no content response
func (o *DeleteNetworkSwitchLinkAggregationNoContent) Code() int {
	return 204
}
...
func (o *DeleteNetworkSwitchLinkAggregationNoContent) String() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/switch/linkAggregations/{linkAggregationId}][%d] deleteNetworkSwitchLinkAggregationNoContent ", 204)
}
