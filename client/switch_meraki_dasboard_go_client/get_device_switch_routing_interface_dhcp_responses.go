...
func (o *GetDeviceSwitchRoutingInterfaceDhcpOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get device switch routing interface dhcp o k response has a 3xx status code
func (o *GetDeviceSwitchRoutingInterfaceDhcpOK) IsRedirect() bool {
	return false
}
...
func (o *GetDeviceSwitchRoutingInterfaceDhcpOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get device switch routing interface dhcp o k response
func (o *GetDeviceSwitchRoutingInterfaceDhcpOK) Code() int {
	return 200
}
...
func (o *GetDeviceSwitchRoutingInterfaceDhcpOK) String() string {
	return fmt.Sprintf("[GET /devices/{serial}/switch/routing/interfaces/{interfaceId}/dhcp][%d] getDeviceSwitchRoutingInterfaceDhcpOK  %+v", 200, o.Payload)
}
