...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) IsClientError() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) IsServerError() bool {
	return false
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network switch routing multicast rendezvous points o k response
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) Code() int {
	return 200
}
...
func (o *GetNetworkSwitchRoutingMulticastRendezvousPointsOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/routing/multicast/rendezvousPoints][%d] getNetworkSwitchRoutingMulticastRendezvousPointsOK  %+v", 200, o.Payload)
}
