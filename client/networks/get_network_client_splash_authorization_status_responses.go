...
func (o *GetNetworkClientSplashAuthorizationStatusOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network client splash authorization status o k response
func (o *GetNetworkClientSplashAuthorizationStatusOK) Code() int {
	return 200
}
...
func (o *GetNetworkClientSplashAuthorizationStatusOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/clients/{clientId}/splashAuthorizationStatus][%d] getNetworkClientSplashAuthorizationStatusOK  %+v", 200, o.Payload)
}
