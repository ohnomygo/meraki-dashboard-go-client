...
func (o *GetNetworkNetworkHealthChannelUtilizationOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network network health channel utilization o k response
func (o *GetNetworkNetworkHealthChannelUtilizationOK) Code() int {
	return 200
}
...
func (o *GetNetworkNetworkHealthChannelUtilizationOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/networkHealth/channelUtilization][%d] getNetworkNetworkHealthChannelUtilizationOK  %+v", 200, o.Payload)
}
