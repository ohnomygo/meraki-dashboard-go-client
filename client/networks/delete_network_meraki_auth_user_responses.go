...
func (o *DeleteNetworkMerakiAuthUserNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete network meraki auth user no content response has a 3xx status code
func (o *DeleteNetworkMerakiAuthUserNoContent) IsRedirect() bool {
	return false
}
...
func (o *DeleteNetworkMerakiAuthUserNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete network meraki auth user no content response
func (o *DeleteNetworkMerakiAuthUserNoContent) Code() int {
	return 204
}
...
func (o *DeleteNetworkMerakiAuthUserNoContent) String() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/merakiAuthUsers/{merakiAuthUserId}][%d] deleteNetworkMerakiAuthUserNoContent ", 204)
}
