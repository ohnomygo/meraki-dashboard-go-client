...
// NewCreateNetworkFirmwareUpgradesStagedEventParams creates a new CreateNetworkFirmwareUpgradesStagedEventParams object,
...
func NewCreateNetworkFirmwareUpgradesStagedEventParams() *CreateNetworkFirmwareUpgradesStagedEventParams {
	return &CreateNetworkFirmwareUpgradesStagedEventParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateNetworkFirmwareUpgradesStagedEventParamsWithTimeout creates a new CreateNetworkFirmwareUpgradesStagedEventParams object
...
// NewCreateNetworkFirmwareUpgradesStagedEventParamsWithContext creates a new CreateNetworkFirmwareUpgradesStagedEventParams object
...
// NewCreateNetworkFirmwareUpgradesStagedEventParamsWithHTTPClient creates a new CreateNetworkFirmwareUpgradesStagedEventParams object
...
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithDefaults() *CreateNetworkFirmwareUpgradesStagedEventParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithTimeout(timeout time.Duration) *CreateNetworkFirmwareUpgradesStagedEventParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithContext(ctx context.Context) *CreateNetworkFirmwareUpgradesStagedEventParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithHTTPClient(client *http.Client) *CreateNetworkFirmwareUpgradesStagedEventParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithCreateNetworkFirmwareUpgradesStagedEvent(createNetworkFirmwareUpgradesStagedEvent CreateNetworkFirmwareUpgradesStagedEventBody) *CreateNetworkFirmwareUpgradesStagedEventParams {
	o.SetCreateNetworkFirmwareUpgradesStagedEvent(createNetworkFirmwareUpgradesStagedEvent)
	return o
}
...
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) SetCreateNetworkFirmwareUpgradesStagedEvent(createNetworkFirmwareUpgradesStagedEvent CreateNetworkFirmwareUpgradesStagedEventBody) {
	o.CreateNetworkFirmwareUpgradesStagedEvent = createNetworkFirmwareUpgradesStagedEvent
}

// WithNetworkID adds the networkID to the create network firmware upgrades staged event params
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WithNetworkID(networkID string) *CreateNetworkFirmwareUpgradesStagedEventParams {
...
func (o *CreateNetworkFirmwareUpgradesStagedEventParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

	if err := r.SetTimeout(o.timeout); err != nil {
		return err
	}
	var res []error
	if err := r.SetBodyParam(o.CreateNetworkFirmwareUpgradesStagedEvent); err != nil {
		return err
	}
