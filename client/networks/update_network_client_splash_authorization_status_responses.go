...
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network client splash authorization status o k response has a 3xx status code
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) IsClientError() bool {
	return false
}
...
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) IsServerError() bool {
	return false
}
...
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkClientSplashAuthorizationStatusOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/clients/{clientId}/splashAuthorizationStatus][%d] updateNetworkClientSplashAuthorizationStatusOK  %+v", 200, o.Payload)
}
