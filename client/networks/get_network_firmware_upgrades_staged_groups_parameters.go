...
// NewGetNetworkFirmwareUpgradesStagedGroupsParams creates a new GetNetworkFirmwareUpgradesStagedGroupsParams object,
...
func NewGetNetworkFirmwareUpgradesStagedGroupsParams() *GetNetworkFirmwareUpgradesStagedGroupsParams {
	return &GetNetworkFirmwareUpgradesStagedGroupsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkFirmwareUpgradesStagedGroupsParamsWithTimeout creates a new GetNetworkFirmwareUpgradesStagedGroupsParams object
...
// NewGetNetworkFirmwareUpgradesStagedGroupsParamsWithContext creates a new GetNetworkFirmwareUpgradesStagedGroupsParams object
...
// NewGetNetworkFirmwareUpgradesStagedGroupsParamsWithHTTPClient creates a new GetNetworkFirmwareUpgradesStagedGroupsParams object
...
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WithDefaults() *GetNetworkFirmwareUpgradesStagedGroupsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get network firmware upgrades staged groups params
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WithTimeout(timeout time.Duration) *GetNetworkFirmwareUpgradesStagedGroupsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get network firmware upgrades staged groups params
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get network firmware upgrades staged groups params
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WithContext(ctx context.Context) *GetNetworkFirmwareUpgradesStagedGroupsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network firmware upgrades staged groups params
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network firmware upgrades staged groups params
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WithHTTPClient(client *http.Client) *GetNetworkFirmwareUpgradesStagedGroupsParams {
...
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WithNetworkID(networkID string) *GetNetworkFirmwareUpgradesStagedGroupsParams {
...
func (o *GetNetworkFirmwareUpgradesStagedGroupsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
