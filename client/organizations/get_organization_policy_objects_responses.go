...
func (o *GetOrganizationPolicyObjectsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationPolicyObjectsOK()
...
func NewGetOrganizationPolicyObjectsOK() *GetOrganizationPolicyObjectsOK {
	return &GetOrganizationPolicyObjectsOK{}
}
...
func (o *GetOrganizationPolicyObjectsOK) Code() int {
	return 200
}

func (o *GetOrganizationPolicyObjectsOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/policyObjects][%d] getOrganizationPolicyObjectsOK  %+v", 200, o.Payload)
}

func (o *GetOrganizationPolicyObjectsOK) String() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/policyObjects][%d] getOrganizationPolicyObjectsOK  %+v", 200, o.Payload)
}
...
func (o *GetOrganizationPolicyObjectsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
