...
func (o *ReleaseFromOrganizationInventoryOK) IsSuccess() bool {
	return true
}
...
func (o *ReleaseFromOrganizationInventoryOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *ReleaseFromOrganizationInventoryOK) String() string {
	return fmt.Sprintf("[POST /organizations/{organizationId}/inventory/release][%d] releaseFromOrganizationInventoryOK  %+v", 200, o.Payload)
}
