...
func (o *DeleteOrganizationBrandingPolicyNoContent) String() string {
	return fmt.Sprintf("[DELETE /organizations/{organizationId}/brandingPolicies/{brandingPolicyId}][%d] deleteOrganizationBrandingPolicyNoContent ", 204)
}
