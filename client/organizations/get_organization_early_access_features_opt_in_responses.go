...
func (o *GetOrganizationEarlyAccessFeaturesOptInReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationEarlyAccessFeaturesOptInOK()
...
func (o *GetOrganizationEarlyAccessFeaturesOptInOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/earlyAccess/features/optIns/{optInId}][%d] getOrganizationEarlyAccessFeaturesOptInOK  %+v", 200, o.Payload)
}

func (o *GetOrganizationEarlyAccessFeaturesOptInOK) String() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/earlyAccess/features/optIns/{optInId}][%d] getOrganizationEarlyAccessFeaturesOptInOK  %+v", 200, o.Payload)
}
...
func (o *GetOrganizationEarlyAccessFeaturesOptInOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
