...
func (o *UpdateOrganizationLicenseOK) GetPayload() *UpdateOrganizationLicenseOKBody {
	return o.Payload
}
...
func (o *UpdateOrganizationLicenseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(UpdateOrganizationLicenseOKBody)
...
// Example: {"deviceSerial":"Q234-ABCD-5678"}
...
/*
UpdateOrganizationLicenseOKBody update organization license o k body
swagger:model UpdateOrganizationLicenseOKBody
*/
...
func (o *UpdateOrganizationLicenseOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UpdateOrganizationLicenseOKBody) validatePermanentlyQueuedLicenses(formats strfmt.Registry) error {
		...
		if o.PermanentlyQueuedLicenses[i] != nil {
			if err := o.PermanentlyQueuedLicenses[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("updateOrganizationLicenseOK" + "." + "permanentlyQueuedLicenses" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("updateOrganizationLicenseOK" + "." + "permanentlyQueuedLicenses" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
var updateOrganizationLicenseOKBodyTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateOrganizationLicenseOKBodyTypeStatePropEnum = append(updateOrganizationLicenseOKBodyTypeStatePropEnum, v)
	}
}
...
// prop value enum
func (o *UpdateOrganizationLicenseOKBody) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateOrganizationLicenseOKBodyTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *UpdateOrganizationLicenseOKBody) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}

	// value enum
	if err := o.validateStateEnum("updateOrganizationLicenseOK"+"."+"state", "body", o.State); err != nil {
		return err
	}
...
func (o *UpdateOrganizationLicenseOKBody) contextValidatePermanentlyQueuedLicenses(ctx context.Context, formats strfmt.Registry) error {
...
func (o *UpdateOrganizationLicenseOKBody) UnmarshalBinary(b []byte) error {
	var res UpdateOrganizationLicenseOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0 update organization license o k body permanently queued licenses items0
swagger:model UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0
*/
...
func (o *UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (o *UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0) UnmarshalBinary(b []byte) error {
	var res UpdateOrganizationLicenseOKBodyPermanentlyQueuedLicensesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
