...
func (o *GetOrganizationAdaptivePolicyGroupOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get organization adaptive policy group o k response has a 3xx status code
func (o *GetOrganizationAdaptivePolicyGroupOK) IsRedirect() bool {
	return false
}
...
func (o *GetOrganizationAdaptivePolicyGroupOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get organization adaptive policy group o k response
func (o *GetOrganizationAdaptivePolicyGroupOK) Code() int {
	return 200
}

func (o *GetOrganizationAdaptivePolicyGroupOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/adaptivePolicy/groups/{id}][%d] getOrganizationAdaptivePolicyGroupOK  %+v", 200, o.Payload)
}

func (o *GetOrganizationAdaptivePolicyGroupOK) String() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/adaptivePolicy/groups/{id}][%d] getOrganizationAdaptivePolicyGroupOK  %+v", 200, o.Payload)
}
