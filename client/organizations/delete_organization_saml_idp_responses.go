...
func (o *DeleteOrganizationSamlIdpNoContent) IsSuccess() bool {
	return true
}
...
func (o *DeleteOrganizationSamlIdpNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete organization saml idp no content response
func (o *DeleteOrganizationSamlIdpNoContent) Code() int {
	return 204
}
...
func (o *DeleteOrganizationSamlIdpNoContent) String() string {
	return fmt.Sprintf("[DELETE /organizations/{organizationId}/saml/idps/{idpId}][%d] deleteOrganizationSamlIdpNoContent ", 204)
}
