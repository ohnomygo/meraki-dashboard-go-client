...
func (o *DeleteOrganizationPolicyObjectsGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteOrganizationPolicyObjectsGroupNoContent()
...
func NewDeleteOrganizationPolicyObjectsGroupNoContent() *DeleteOrganizationPolicyObjectsGroupNoContent {
	return &DeleteOrganizationPolicyObjectsGroupNoContent{}
}
...
func (o *DeleteOrganizationPolicyObjectsGroupNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete organization policy objects group no content response
func (o *DeleteOrganizationPolicyObjectsGroupNoContent) Code() int {
	return 204
}

func (o *DeleteOrganizationPolicyObjectsGroupNoContent) Error() string {
	return fmt.Sprintf("[DELETE /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId}][%d] deleteOrganizationPolicyObjectsGroupNoContent ", 204)
}

func (o *DeleteOrganizationPolicyObjectsGroupNoContent) String() string {
	return fmt.Sprintf("[DELETE /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId}][%d] deleteOrganizationPolicyObjectsGroupNoContent ", 204)
}

func (o *DeleteOrganizationPolicyObjectsGroupNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
