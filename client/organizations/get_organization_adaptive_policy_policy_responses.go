...
func (o *GetOrganizationAdaptivePolicyPolicyOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get organization adaptive policy policy o k response has a 3xx status code
func (o *GetOrganizationAdaptivePolicyPolicyOK) IsRedirect() bool {
	return false
}
...
func (o *GetOrganizationAdaptivePolicyPolicyOK) IsCode(code int) bool {
	return code == 200
}
