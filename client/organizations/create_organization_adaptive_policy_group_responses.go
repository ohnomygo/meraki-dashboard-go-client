...
func (o *CreateOrganizationAdaptivePolicyGroupCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *CreateOrganizationAdaptivePolicyGroupCreated) String() string {
	return fmt.Sprintf("[POST /organizations/{organizationId}/adaptivePolicy/groups][%d] createOrganizationAdaptivePolicyGroupCreated  %+v", 201, o.Payload)
}
