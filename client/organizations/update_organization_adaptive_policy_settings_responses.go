...
func (o *UpdateOrganizationAdaptivePolicySettingsOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateOrganizationAdaptivePolicySettingsOK) String() string {
	return fmt.Sprintf("[PUT /organizations/{organizationId}/adaptivePolicy/settings][%d] updateOrganizationAdaptivePolicySettingsOK  %+v", 200, o.Payload)
}
