...
func (o *DeleteOrganizationConfigTemplateNoContent) String() string {
	return fmt.Sprintf("[DELETE /organizations/{organizationId}/configTemplates/{configTemplateId}][%d] deleteOrganizationConfigTemplateNoContent ", 204)
}
