...
func (o *GetNetworkSensorMqttBrokersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSensorMqttBrokersOK()
...
func NewGetNetworkSensorMqttBrokersOK() *GetNetworkSensorMqttBrokersOK {
	return &GetNetworkSensorMqttBrokersOK{}
}
...
func (o *GetNetworkSensorMqttBrokersOK) Code() int {
	return 200
}

func (o *GetNetworkSensorMqttBrokersOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/sensor/mqttBrokers][%d] getNetworkSensorMqttBrokersOK  %+v", 200, o.Payload)
}

func (o *GetNetworkSensorMqttBrokersOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/sensor/mqttBrokers][%d] getNetworkSensorMqttBrokersOK  %+v", 200, o.Payload)
}

func (o *GetNetworkSensorMqttBrokersOK) GetPayload() []*GetNetworkSensorMqttBrokersOKBodyItems0 {
	return o.Payload
}

func (o *GetNetworkSensorMqttBrokersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
GetNetworkSensorMqttBrokersOKBodyItems0 get network sensor mqtt brokers o k body items0
swagger:model GetNetworkSensorMqttBrokersOKBodyItems0
*/
...
func (o *GetNetworkSensorMqttBrokersOKBodyItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get network sensor mqtt brokers o k body items0 based on context it is used
func (o *GetNetworkSensorMqttBrokersOKBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (o *GetNetworkSensorMqttBrokersOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetNetworkSensorMqttBrokersOKBodyItems0
