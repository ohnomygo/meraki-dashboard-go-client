...
// NewGetNetworkSensorMqttBrokerParams creates a new GetNetworkSensorMqttBrokerParams object,
...
func NewGetNetworkSensorMqttBrokerParams() *GetNetworkSensorMqttBrokerParams {
	return &GetNetworkSensorMqttBrokerParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSensorMqttBrokerParamsWithTimeout creates a new GetNetworkSensorMqttBrokerParams object
...
// NewGetNetworkSensorMqttBrokerParamsWithContext creates a new GetNetworkSensorMqttBrokerParams object
...
// NewGetNetworkSensorMqttBrokerParamsWithHTTPClient creates a new GetNetworkSensorMqttBrokerParams object
...
func (o *GetNetworkSensorMqttBrokerParams) WithDefaults() *GetNetworkSensorMqttBrokerParams {
	o.SetDefaults()
	return o
}
...
func (o *GetNetworkSensorMqttBrokerParams) WithTimeout(timeout time.Duration) *GetNetworkSensorMqttBrokerParams {
...
func (o *GetNetworkSensorMqttBrokerParams) WithContext(ctx context.Context) *GetNetworkSensorMqttBrokerParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network sensor mqtt broker params
func (o *GetNetworkSensorMqttBrokerParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network sensor mqtt broker params
func (o *GetNetworkSensorMqttBrokerParams) WithHTTPClient(client *http.Client) *GetNetworkSensorMqttBrokerParams {
...
func (o *GetNetworkSensorMqttBrokerParams) WithMqttBrokerID(mqttBrokerID string) *GetNetworkSensorMqttBrokerParams {
...
func (o *GetNetworkSensorMqttBrokerParams) WithNetworkID(networkID string) *GetNetworkSensorMqttBrokerParams {
...
func (o *GetNetworkSensorMqttBrokerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
