...
// NewGetDeviceSensorRelationshipsParams creates a new GetDeviceSensorRelationshipsParams object,
...
func NewGetDeviceSensorRelationshipsParams() *GetDeviceSensorRelationshipsParams {
	return &GetDeviceSensorRelationshipsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDeviceSensorRelationshipsParamsWithTimeout creates a new GetDeviceSensorRelationshipsParams object
...
// NewGetDeviceSensorRelationshipsParamsWithContext creates a new GetDeviceSensorRelationshipsParams object
...
// NewGetDeviceSensorRelationshipsParamsWithHTTPClient creates a new GetDeviceSensorRelationshipsParams object
...
func (o *GetDeviceSensorRelationshipsParams) WithDefaults() *GetDeviceSensorRelationshipsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetDeviceSensorRelationshipsParams) WithTimeout(timeout time.Duration) *GetDeviceSensorRelationshipsParams {
...
func (o *GetDeviceSensorRelationshipsParams) WithContext(ctx context.Context) *GetDeviceSensorRelationshipsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get device sensor relationships params
func (o *GetDeviceSensorRelationshipsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get device sensor relationships params
func (o *GetDeviceSensorRelationshipsParams) WithHTTPClient(client *http.Client) *GetDeviceSensorRelationshipsParams {
...
func (o *GetDeviceSensorRelationshipsParams) WithSerial(serial string) *GetDeviceSensorRelationshipsParams {
	o.SetSerial(serial)
	return o
}
...
func (o *GetDeviceSensorRelationshipsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
