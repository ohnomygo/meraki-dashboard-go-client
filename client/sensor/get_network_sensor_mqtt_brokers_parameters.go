...
// NewGetNetworkSensorMqttBrokersParams creates a new GetNetworkSensorMqttBrokersParams object,
...
func NewGetNetworkSensorMqttBrokersParams() *GetNetworkSensorMqttBrokersParams {
	return &GetNetworkSensorMqttBrokersParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSensorMqttBrokersParamsWithTimeout creates a new GetNetworkSensorMqttBrokersParams object
...
// NewGetNetworkSensorMqttBrokersParamsWithContext creates a new GetNetworkSensorMqttBrokersParams object
...
// NewGetNetworkSensorMqttBrokersParamsWithHTTPClient creates a new GetNetworkSensorMqttBrokersParams object
...
func (o *GetNetworkSensorMqttBrokersParams) WithDefaults() *GetNetworkSensorMqttBrokersParams {
	o.SetDefaults()
	return o
}
...
func (o *GetNetworkSensorMqttBrokersParams) WithTimeout(timeout time.Duration) *GetNetworkSensorMqttBrokersParams {
...
func (o *GetNetworkSensorMqttBrokersParams) WithContext(ctx context.Context) *GetNetworkSensorMqttBrokersParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network sensor mqtt brokers params
func (o *GetNetworkSensorMqttBrokersParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network sensor mqtt brokers params
func (o *GetNetworkSensorMqttBrokersParams) WithHTTPClient(client *http.Client) *GetNetworkSensorMqttBrokersParams {
...
func (o *GetNetworkSensorMqttBrokersParams) WithNetworkID(networkID string) *GetNetworkSensorMqttBrokersParams {
...
func (o *GetNetworkSensorMqttBrokersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
