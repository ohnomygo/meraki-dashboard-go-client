...
// NewGetDeviceCellularSimsParams creates a new GetDeviceCellularSimsParams object,
...
func NewGetDeviceCellularSimsParams() *GetDeviceCellularSimsParams {
	return &GetDeviceCellularSimsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDeviceCellularSimsParamsWithTimeout creates a new GetDeviceCellularSimsParams object
...
// NewGetDeviceCellularSimsParamsWithContext creates a new GetDeviceCellularSimsParams object
...
// NewGetDeviceCellularSimsParamsWithHTTPClient creates a new GetDeviceCellularSimsParams object
...
func (o *GetDeviceCellularSimsParams) WithDefaults() *GetDeviceCellularSimsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetDeviceCellularSimsParams) WithTimeout(timeout time.Duration) *GetDeviceCellularSimsParams {
...
func (o *GetDeviceCellularSimsParams) WithContext(ctx context.Context) *GetDeviceCellularSimsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetDeviceCellularSimsParams) WithHTTPClient(client *http.Client) *GetDeviceCellularSimsParams {
...
func (o *GetDeviceCellularSimsParams) WithSerial(serial string) *GetDeviceCellularSimsParams {
	o.SetSerial(serial)
	return o
}
...
func (o *GetDeviceCellularSimsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
