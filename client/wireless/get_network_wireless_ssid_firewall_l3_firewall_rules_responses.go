...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) IsClientError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) IsServerError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless ssid firewall l3 firewall rules o k response
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessSsidFirewallL3FirewallRulesOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/ssids/{number}/firewall/l3FirewallRules][%d] getNetworkWirelessSsidFirewallL3FirewallRulesOK  %+v", 200, o.Payload)
}
