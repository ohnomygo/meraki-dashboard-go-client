...
func (o *GetNetworkWirelessClientsConnectionStatsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless clients connection stats o k response
func (o *GetNetworkWirelessClientsConnectionStatsOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessClientsConnectionStatsOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/clients/connectionStats][%d] getNetworkWirelessClientsConnectionStatsOK  %+v", 200, o.Payload)
}
