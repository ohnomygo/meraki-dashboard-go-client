...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) IsClientError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) IsServerError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless ssid firewall l7 firewall rules o k response
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessSsidFirewallL7FirewallRulesOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/ssids/{number}/firewall/l7FirewallRules][%d] getNetworkWirelessSsidFirewallL7FirewallRulesOK  %+v", 200, o.Payload)
}
