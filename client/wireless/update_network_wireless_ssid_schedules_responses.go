...
func (o *UpdateNetworkWirelessSsidSchedulesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network wireless ssid schedules o k response has a 3xx status code
func (o *UpdateNetworkWirelessSsidSchedulesOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkWirelessSsidSchedulesOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkWirelessSsidSchedulesOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/wireless/ssids/{number}/schedules][%d] updateNetworkWirelessSsidSchedulesOK  %+v", 200, o.Payload)
}
