...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) IsClientError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) IsServerError() bool {
	return false
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless ssid device type group policies o k response
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/ssids/{number}/deviceTypeGroupPolicies][%d] getNetworkWirelessSsidDeviceTypeGroupPoliciesOK  %+v", 200, o.Payload)
}
