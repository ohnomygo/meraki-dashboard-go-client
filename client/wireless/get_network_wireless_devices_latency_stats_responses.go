...
func (o *GetNetworkWirelessDevicesLatencyStatsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get network wireless devices latency stats o k response has a 3xx status code
func (o *GetNetworkWirelessDevicesLatencyStatsOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkWirelessDevicesLatencyStatsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless devices latency stats o k response
func (o *GetNetworkWirelessDevicesLatencyStatsOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessDevicesLatencyStatsOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/devices/latencyStats][%d] getNetworkWirelessDevicesLatencyStatsOK  %+v", 200, o.Payload)
}
