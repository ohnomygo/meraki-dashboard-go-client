...
func (o *UpdateNetworkWirelessSsidHotspot20OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network wireless ssid hotspot20 o k response has a 3xx status code
func (o *UpdateNetworkWirelessSsidHotspot20OK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkWirelessSsidHotspot20OK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkWirelessSsidHotspot20OK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/wireless/ssids/{number}/hotspot20][%d] updateNetworkWirelessSsidHotspot20OK  %+v", 200, o.Payload)
}
