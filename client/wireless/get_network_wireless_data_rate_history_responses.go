...
func (o *GetNetworkWirelessDataRateHistoryOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkWirelessDataRateHistoryOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network wireless data rate history o k response
func (o *GetNetworkWirelessDataRateHistoryOK) Code() int {
	return 200
}
...
func (o *GetNetworkWirelessDataRateHistoryOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/dataRateHistory][%d] getNetworkWirelessDataRateHistoryOK  %+v", 200, o.Payload)
}

func (o *GetNetworkWirelessDataRateHistoryOK) GetPayload() []*GetNetworkWirelessDataRateHistoryOKBodyItems0 {
	return o.Payload
}
...
/*
GetNetworkWirelessDataRateHistoryOKBodyItems0 get network wireless data rate history o k body items0
swagger:model GetNetworkWirelessDataRateHistoryOKBodyItems0
*/
...
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) validateEndTs(formats strfmt.Registry) error {
...
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) validateStartTs(formats strfmt.Registry) error {
...
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetNetworkWirelessDataRateHistoryOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res GetNetworkWirelessDataRateHistoryOKBodyItems0
