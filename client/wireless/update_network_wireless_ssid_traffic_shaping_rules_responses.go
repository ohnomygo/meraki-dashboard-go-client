...
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network wireless ssid traffic shaping rules o k response has a 3xx status code
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) IsClientError() bool {
	return false
}
...
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) IsServerError() bool {
	return false
}
...
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkWirelessSsidTrafficShapingRulesOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/wireless/ssids/{number}/trafficShaping/rules][%d] updateNetworkWirelessSsidTrafficShapingRulesOK  %+v", 200, o.Payload)
}
