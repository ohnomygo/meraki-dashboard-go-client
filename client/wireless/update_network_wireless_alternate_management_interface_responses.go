...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) IsSuccess() bool {
	return true
}
...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) IsClientError() bool {
	return false
}
...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) IsServerError() bool {
	return false
}
...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkWirelessAlternateManagementInterfaceOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/wireless/alternateManagementInterface][%d] updateNetworkWirelessAlternateManagementInterfaceOK  %+v", 200, o.Payload)
}
