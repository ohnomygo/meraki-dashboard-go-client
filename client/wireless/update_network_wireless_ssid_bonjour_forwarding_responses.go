...
func (o *UpdateNetworkWirelessSsidBonjourForwardingOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkWirelessSsidBonjourForwardingOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/wireless/ssids/{number}/bonjourForwarding][%d] updateNetworkWirelessSsidBonjourForwardingOK  %+v", 200, o.Payload)
}
