...
func (o *UpdateDeviceWirelessRadioSettingsOK) IsSuccess() bool {
	return true
}
...
func (o *UpdateDeviceWirelessRadioSettingsOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateDeviceWirelessRadioSettingsOK) String() string {
	return fmt.Sprintf("[PUT /devices/{serial}/wireless/radio/settings][%d] updateDeviceWirelessRadioSettingsOK  %+v", 200, o.Payload)
}
