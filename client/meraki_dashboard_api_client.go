...
import (
	...
	"github.com/dashboard-api-go-swag/client/administered"
	"github.com/dashboard-api-go-swag/client/appliance"
	"github.com/dashboard-api-go-swag/client/camera"
...
// Default meraki dashboard API HTTP client.
...
// NewHTTPClient creates a new meraki dashboard API HTTP client.
func NewHTTPClient(formats strfmt.Registry) *MerakiDashboardAPI {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new meraki dashboard API HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *MerakiDashboardAPI {
...
// New creates a new meraki dashboard API client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *MerakiDashboardAPI {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(MerakiDashboardAPI)
...
// MerakiDashboardAPI is a client for meraki dashboard API
type MerakiDashboardAPI struct {
...
func (c *MerakiDashboardAPI) SetTransport(transport runtime.ClientTransport) {
