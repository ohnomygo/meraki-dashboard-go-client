...
func (o *GetNetworkCameraWirelessProfilesOK) IsSuccess() bool {
	return true
}
...
func (o *GetNetworkCameraWirelessProfilesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network camera wireless profiles o k response
func (o *GetNetworkCameraWirelessProfilesOK) Code() int {
	return 200
}
...
func (o *GetNetworkCameraWirelessProfilesOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/camera/wirelessProfiles][%d] getNetworkCameraWirelessProfilesOK  %+v", 200, o.Payload)
}
