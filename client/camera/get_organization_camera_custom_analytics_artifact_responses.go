...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get organization camera custom analytics artifact o k response has a 3xx status code
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) IsRedirect() bool {
	return false
}
...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) IsClientError() bool {
	return false
}
...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) IsServerError() bool {
	return false
}
...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get organization camera custom analytics artifact o k response
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) Code() int {
	return 200
}
...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) String() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/camera/customAnalytics/artifacts/{artifactId}][%d] getOrganizationCameraCustomAnalyticsArtifactOK  %+v", 200, o.Payload)
}
