...
func (o *UpdateNetworkCameraWirelessProfileOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network camera wireless profile o k response has a 3xx status code
func (o *UpdateNetworkCameraWirelessProfileOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkCameraWirelessProfileOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkCameraWirelessProfileOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/camera/wirelessProfiles/{wirelessProfileId}][%d] updateNetworkCameraWirelessProfileOK  %+v", 200, o.Payload)
}
