...
func (o *GetDeviceCameraAnalyticsZoneHistoryOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get device camera analytics zone history o k response has a 3xx status code
func (o *GetDeviceCameraAnalyticsZoneHistoryOK) IsRedirect() bool {
	return false
}
...
func (o *GetDeviceCameraAnalyticsZoneHistoryOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get device camera analytics zone history o k response
func (o *GetDeviceCameraAnalyticsZoneHistoryOK) Code() int {
	return 200
}
...
func (o *GetDeviceCameraAnalyticsZoneHistoryOK) String() string {
	return fmt.Sprintf("[GET /devices/{serial}/camera/analytics/zones/{zoneId}/history][%d] getDeviceCameraAnalyticsZoneHistoryOK  %+v", 200, o.Payload)
}
