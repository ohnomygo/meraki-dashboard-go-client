...
func (o *UpdateDeviceCameraWirelessProfilesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update device camera wireless profiles o k response has a 3xx status code
func (o *UpdateDeviceCameraWirelessProfilesOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateDeviceCameraWirelessProfilesOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateDeviceCameraWirelessProfilesOK) String() string {
	return fmt.Sprintf("[PUT /devices/{serial}/camera/wirelessProfiles][%d] updateDeviceCameraWirelessProfilesOK  %+v", 200, o.Payload)
}
