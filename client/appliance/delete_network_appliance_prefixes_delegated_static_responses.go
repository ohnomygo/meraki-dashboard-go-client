...
func (o *DeleteNetworkAppliancePrefixesDelegatedStaticReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteNetworkAppliancePrefixesDelegatedStaticNoContent()
...
func NewDeleteNetworkAppliancePrefixesDelegatedStaticNoContent() *DeleteNetworkAppliancePrefixesDelegatedStaticNoContent {
	return &DeleteNetworkAppliancePrefixesDelegatedStaticNoContent{}
}
...
func (o *DeleteNetworkAppliancePrefixesDelegatedStaticNoContent) Error() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/appliance/prefixes/delegated/statics/{staticDelegatedPrefixId}][%d] deleteNetworkAppliancePrefixesDelegatedStaticNoContent ", 204)
}
...
func (o *DeleteNetworkAppliancePrefixesDelegatedStaticNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
