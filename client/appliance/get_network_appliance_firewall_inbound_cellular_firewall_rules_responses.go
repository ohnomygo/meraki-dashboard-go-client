...
func (o *GetNetworkApplianceFirewallInboundCellularFirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceFirewallInboundCellularFirewallRulesOK()
...
func NewGetNetworkApplianceFirewallInboundCellularFirewallRulesOK() *GetNetworkApplianceFirewallInboundCellularFirewallRulesOK {
	return &GetNetworkApplianceFirewallInboundCellularFirewallRulesOK{}
}
...
func (o *GetNetworkApplianceFirewallInboundCellularFirewallRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/firewall/inboundCellularFirewallRules][%d] getNetworkApplianceFirewallInboundCellularFirewallRulesOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkApplianceFirewallInboundCellularFirewallRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
