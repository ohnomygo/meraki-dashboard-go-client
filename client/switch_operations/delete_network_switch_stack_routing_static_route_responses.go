...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) IsSuccess() bool {
	return true
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) IsRedirect() bool {
	return false
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) IsClientError() bool {
	return false
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) IsServerError() bool {
	return false
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete network switch stack routing static route no content response
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) Code() int {
	return 204
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) String() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes/{staticRouteId}][%d] deleteNetworkSwitchStackRoutingStaticRouteNoContent ", 204)
}
