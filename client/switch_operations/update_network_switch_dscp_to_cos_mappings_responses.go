...
func (o *UpdateNetworkSwitchDscpToCosMappingsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update network switch dscp to cos mappings o k response has a 3xx status code
func (o *UpdateNetworkSwitchDscpToCosMappingsOK) IsRedirect() bool {
	return false
}
...
func (o *UpdateNetworkSwitchDscpToCosMappingsOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateNetworkSwitchDscpToCosMappingsOK) String() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/switch/dscpToCosMappings][%d] updateNetworkSwitchDscpToCosMappingsOK  %+v", 200, o.Payload)
}
