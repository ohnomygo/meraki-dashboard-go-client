...
// NewUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams creates a new UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams object,
...
func NewUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams() *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	return &UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParamsWithTimeout creates a new UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams object
...
// NewUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParamsWithContext creates a new UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams object
...
// NewUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParamsWithHTTPClient creates a new UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams object
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithDefaults() *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetDefaults() {
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithTimeout(timeout time.Duration) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithContext(ctx context.Context) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithHTTPClient(client *http.Client) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithNetworkID adds the networkID to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithNetworkID(networkID string) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	o.SetNetworkID(networkID)
	return o
}

// SetNetworkID adds the networkId to the update network switch dhcp server policy arp inspection trusted server params
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetNetworkID(networkID string) {
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithTrustedServerID(trustedServerID string) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WithUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer(updateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerBody) *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams {
	o.SetUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer(updateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer)
	return o
}
...
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) SetUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer(updateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerBody) {
	o.UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer = updateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer
}

// WriteToRequest writes these params to a swagger request
func (o *UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetBodyParam(o.UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServer); err != nil {
		return err
	}
