...
func (o *GetNetworkSwitchStackRoutingInterfaceOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get network switch stack routing interface o k response has a 3xx status code
func (o *GetNetworkSwitchStackRoutingInterfaceOK) IsRedirect() bool {
	return false
}
...
func (o *GetNetworkSwitchStackRoutingInterfaceOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get network switch stack routing interface o k response
func (o *GetNetworkSwitchStackRoutingInterfaceOK) Code() int {
	return 200
}
...
func (o *GetNetworkSwitchStackRoutingInterfaceOK) String() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/stacks/{switchStackId}/routing/interfaces/{interfaceId}][%d] getNetworkSwitchStackRoutingInterfaceOK  %+v", 200, o.Payload)
}
