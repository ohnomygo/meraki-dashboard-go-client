...
func (o *DeleteDeviceSwitchRoutingStaticRouteNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the delete device switch routing static route no content response
func (o *DeleteDeviceSwitchRoutingStaticRouteNoContent) Code() int {
	return 204
}
...
func (o *DeleteDeviceSwitchRoutingStaticRouteNoContent) String() string {
	return fmt.Sprintf("[DELETE /devices/{serial}/switch/routing/staticRoutes/{staticRouteId}][%d] deleteDeviceSwitchRoutingStaticRouteNoContent ", 204)
}
