...
func (o *CreateDeviceSwitchRoutingStaticRouteCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *CreateDeviceSwitchRoutingStaticRouteCreated) String() string {
	return fmt.Sprintf("[POST /devices/{serial}/switch/routing/staticRoutes][%d] createDeviceSwitchRoutingStaticRouteCreated  %+v", 201, o.Payload)
}
