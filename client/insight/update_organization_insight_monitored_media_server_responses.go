...
// IsSuccess returns true when this update organization insight monitored media server o k response has a 2xx status code
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update organization insight monitored media server o k response has a 3xx status code
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update organization insight monitored media server o k response has a 4xx status code
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update organization insight monitored media server o k response has a 5xx status code
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update organization insight monitored media server o k response a status code equal to that given
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *UpdateOrganizationInsightMonitoredMediaServerOK) String() string {
	return fmt.Sprintf("[PUT /organizations/{organizationId}/insight/monitoredMediaServers/{monitoredMediaServerId}][%d] updateOrganizationInsightMonitoredMediaServerOK  %+v", 200, o.Payload)
}
