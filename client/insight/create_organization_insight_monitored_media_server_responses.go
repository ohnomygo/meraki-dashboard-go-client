...
// IsSuccess returns true when this create organization insight monitored media server created response has a 2xx status code
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create organization insight monitored media server created response has a 3xx status code
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create organization insight monitored media server created response has a 4xx status code
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this create organization insight monitored media server created response has a 5xx status code
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this create organization insight monitored media server created response a status code equal to that given
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *CreateOrganizationInsightMonitoredMediaServerCreated) String() string {
	return fmt.Sprintf("[POST /organizations/{organizationId}/insight/monitoredMediaServers][%d] createOrganizationInsightMonitoredMediaServerCreated  %+v", 201, o.Payload)
}
